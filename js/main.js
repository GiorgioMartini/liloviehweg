$(document).ready(function() {
  ...
  var places = {
    ...
    stutzpunkt: '<h2>Stützpunkt</h2><p >www.dorfmite.productions/dorf</p>',
    libken: '<h2>Libken</h2><p >www.libken.de</p>',
    bushaltesstelle: 'Bushaltesstelle',
    pretty:'Pretty Woman',
    axel: 'Axel',
    cafe:'<h2>Café zum Löwen</h2><p >www.dorfmitte.productions/dorf</p>',
    lindenplatz:'<h2>Lindenplatz</h2><p >www.dorfmitte.productions/dorf</p>',
    kirche:'Kirche',
    doner:'Döner Imbiss',
    renate:'Heinrich und Renate',
    gluundspaene:'Fischmann Micha',
    gar:'<h2>Schlossgärtnerei</h2><p >www.dorfmitte.productions/gar</p>',
    erna:'Erna und Elli',
    gewachshaus:'<h2>Gewächshaus</h2><p >www.dorfmitte.productions/gar</p>',
    nele:'Nele',
