...
<pre><code class="language-javascript">// Simple SPDX license expression for dual licensing
assert.deepEqual(
...
<pre><code class="language-javascript">var warningAboutLicenseRef = {
  validForOldPackages: false,
  validForNewPackages: false,
  spdx: true,
  warnings: [
...
<pre><code class="language-javascript">var unlicensed = {
  validForNewPackages: true,
  validForOldPackages: true,
  unlicensed: true
};
