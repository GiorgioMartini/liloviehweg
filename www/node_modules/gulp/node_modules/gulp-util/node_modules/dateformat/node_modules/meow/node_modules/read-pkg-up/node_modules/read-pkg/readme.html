...
<h2>Install</h2><pre><code>$ npm install --save read-pkg
</code></pre><h2>Usage</h2><pre><code class="language-js">var readPkg = require(&#39;read-pkg&#39;);
...
<h2>API</h2><h3>readPkg([path], [options])</h3><p>Returns a promise that resolves to the parsed JSON.</p>
<h3>readPkg.sync([path], [options])</h3><p>Returns the parsed JSON.</p>
<h4>path</h4><p>Type: <code>string</code><br>Default: <code>.</code></p>
<p>Path to a <code>package.json</code> file or its directory.</p>
<h4>options</h4><h5>normalize</h5><p>Type: <code>boolean</code><br>Default: <code>true</code></p>
